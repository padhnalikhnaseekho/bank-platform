...
class CsvStatementRendererTest {
    ...
    void rendersOneRowPerEntry() {
        AccountActivityEntry entry = AccountActivityEntry.create(UUID.randomUUID(), UUID.randomUUID(), "DEPOSIT",
                new BigDecimal("100.00"), "INR", Instant.parse("2026-01-01T00:00:00Z"));
