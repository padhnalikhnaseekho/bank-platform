...
/**
 * Verifies fraud-service can still read the shared transfer-completed contract fixture
 * published by account-service (see TransferOutcomePayloadContractTest there). sourceCustomerId
 * in particular is load-bearing here: FraudDetectionTopologyBuilder re-keys the stream by it.
 */
