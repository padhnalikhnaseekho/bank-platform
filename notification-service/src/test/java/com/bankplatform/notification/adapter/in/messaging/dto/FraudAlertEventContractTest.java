...
/**
 * Verifies notification-service can still read the shared fraud-alert contract fixture
 * published by fraud-service (see FraudAlertContractTest there).
 */
class FraudAlertEventContractTest {
    ...
    void deserializesFraudAlertContract() {
        ...
        assertThat(event.message()).isEqualTo("Customer exceeded 5 transfers within a 10 minute window");
    }
}
