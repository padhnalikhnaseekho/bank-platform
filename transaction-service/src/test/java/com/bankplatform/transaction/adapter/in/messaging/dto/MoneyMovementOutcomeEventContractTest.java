...
/**
 * Verifies transaction-service can still read the shared money-deposited/money-withdrawn contract
 * fixtures published by account-service (see MoneyMovementOutcomePayloadContractTest there). This
 * DTO deliberately omits customerId, unlike notification-service and reporting-service's copies —
 * locked in here as a subset by choice.
 */
