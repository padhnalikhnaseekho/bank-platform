...
/**
 * Verifies transaction-service's actual transfer-started payload still matches the shared contract
 * fixture consumed by account-service's TransactionCreatedEvent. A field rename here without
 * updating the fixture (and every consumer) fails this test instead of silently dropping data at
 * the consumer.
 */
