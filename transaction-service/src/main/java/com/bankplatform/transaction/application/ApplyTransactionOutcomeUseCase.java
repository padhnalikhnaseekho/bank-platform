...
/**
 * Kept as its own bean (rather than inlined in TransactionOutcomeListener) so the transactional
...
public class ApplyTransactionOutcomeUseCase {
    ...
    public ApplyTransactionOutcomeUseCase(
                        ...
                        .orElseThrow(
                                () ->
                                        new IllegalStateException(
                                                "Unknown transaction: " + transactionIdValue));
        if (success) {
